...
class ShapeAttributePanel extends BaseAttribute {
  ShapeAttributePanel({super.key}) : super();

  final _designData = [
    WrapExpanstionPanelItem(
        //도형
        headerValue: 'shape'.tr,
        child: ShapeDesignItem()),
  ];
  ...
  @override
  Widget buildStyle() =>
      SingleChildScrollView(child: WrapExpansionPanelList(data: _styleData));

  @override
  Widget buildDesign() =>
      SingleChildScrollView(child: WrapExpansionPanelList(data: _designData));

  @override
  Widget buildAnimation() => SingleChildScrollView(child: AnimationItem());
}
