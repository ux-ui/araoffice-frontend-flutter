...
class $AssetsFontsGen {
  ...
  String get pretendardRegular =>
      'packages/app_ui/assets/fonts/Pretendard-Regular.woff';

  /// List of all assets
  List<String> get values => [pretendardRegular];
}
...
class $AssetsIconsGen {
  ...
  SvgGenImage get bar => const SvgGenImage('assets/icons/bar.svg');

  /// File path: assets/icons/bell.svg
  SvgGenImage get bell => const SvgGenImage('assets/icons/bell.svg');

  /// List of all assets
  List<SvgGenImage> get values => [apple, award, backIcon, bar, bell];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/big_media.png
  AssetGenImage get bigMedia =>
      const AssetGenImage('assets/images/big_media.png');
